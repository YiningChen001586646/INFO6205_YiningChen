...
public class Benchmark_Timer<T> implements Benchmark<T> {
    ...
    //partially sorted  
    	 ...
    	 WQUPC wqupc =new WQUPC(1000); //Test weighted quick union with path compression, do two loops
    	 UF_HWQUPC uf=new UF_HWQUPC (1000,false);//Test weighted quick union, store the depth
    	 WQUPCNOPASS np=new WQUPCNOPASS(1000);//Test weighted quick union, store the size 
     	int runTime1=1000;
     	
     	Benchmark_Timer benchmark_timer3 = new Benchmark_Timer("Test weighted quick union, store the size", t->np.UnionFind(1000));
       	System.out.println("time: " +benchmark_timer3.run(1000,runTime1));
     	Benchmark_Timer benchmark_timer2=new Benchmark_Timer("Test weighted quick union, store the depth", t->uf.UnionFind(1000, false));
    	System.out.println("time: " +benchmark_timer2.run(1000,runTime1));
     	Benchmark_Timer benchmark_timer1 = new Benchmark_Timer("Test weighted quick union with path compression, do two loops", t->wqupc.UnionFind(1000));
       	System.out.println("time: " +benchmark_timer1.run(1000,runTime1));
     	Benchmark_Timer benchmark_timer4=new Benchmark_Timer("Test weighted quick union, with path cpmpression", t->uf.UnionFind(1000, true ));
    	System.out.println("time: " +benchmark_timer4.run(1000,runTime1));
